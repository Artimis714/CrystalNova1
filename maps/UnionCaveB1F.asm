...
HikerPhillipAfterBattleText:
	...
	line "I'm sorry I jumped"
	cont "you like that."

	para "I don't want to"
	line "end up in a KANTO"
	cont "Prison."
	done
...
HikerLeonardAfterBattleText:
	...
	para "Yes, I'm a war"
	line "criminal. We all"
	cont "are."

	para "But I ask that you"
	line "not think less of"
	cont "me for it."
	done
