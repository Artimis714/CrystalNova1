...
PicnickerEdnaAfterBattleText:
	...
	para "Global warming is"
	line "terrible. That's"
...
HikerTimSeenText:
	...
	para "Really? They're"
	line "called the sacred"
	cont "SILVER MOUNTAINS?"
	done
