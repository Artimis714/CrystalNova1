...
WiseTriosRoomSage2Text:
	...
	para "It's shameful for"
	line "young people to"

	para "continue to des-"
	line "ecrate the once"
...
SageKojiAfterBattleSpeechText:
	...
	para "We, the WISE TRIO,"
	line "have upheld the"

	para "responsibility of"
	line "protecting the"
