...
MahoganyMart1FGrannyScript:
	faceplayer
	opentext
	pokemart MARTTYPE_BALL, MART_MAHOGANY_2
	closetext
	end
...
MahoganyMart1FLanceRadioText:
	...
	para "Yes, I just had my"
	line "DRAGONITE use"

	para "HYPER BEAM on a"
	line "human."

	para "..."

	para "These rebels are"
	line "threatening the"

	para "tenuous peace we"
	line "have with KANTO."
...
MahoganyMart1FLanceStairsText:
	...
	para "You've seen what"
	line "these ROCKETS"

	para "are willing to"
	line "do. Toughen, up"
	cont "kid, this is war."

	para "..."
	line "..."

	para "It's good you're"
	line "with me."
	done
...
MahoganyMart1F_MapEvents:
	...
	object_event  3,  6, SPRITE_DRAGONITE_MOVE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_DRAGONITE
	object_event  1,  3, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyMart1FGrannyScript, EVENT_MAHOGANY_MART_OWNERS
