...
.AliceUnmasked:
	...
	reloadmapafterbattle
	setevent EVENT_BEAT_LASS_ALICE
	disappear FUCHSIAGYM_FUCHSIA_GYM_1
	end
...
.LindaUnmasked:
	...
	reloadmapafterbattle
	setevent EVENT_BEAT_LASS_LINDA
	disappear FUCHSIAGYM_FUCHSIA_GYM_2
	end
...
.CindyUnmasked:
	...
	reloadmapafterbattle
	setevent EVENT_BEAT_PICNICKER_CINDY
	disappear FUCHSIAGYM_FUCHSIA_GYM_3
	end
...
.BarryUnmasked:
	...
	reloadmapafterbattle
	setevent EVENT_BEAT_CAMPER_BARRY
	disappear FUCHSIAGYM_FUCHSIA_GYM_4
	end
...
JanineText_DisappointYou:
	...
	line "I'm the real deal!"

	para "I see you've dealt"
	line "with all of my"
	cont "SHADOW CLONES."
	...
	para "WHAT? You bested"
	line "my father!?"

	para "As HOKAGE of the"
	line "village hidden in"

	para "the smog, I shall"
	line "avenge my father's"
	cont "defeat!"
	done
...
JanineText_ToxicSpeech:
	...
	para "It's TOXIC, a rare"
	line "poison juitsu that"
	...
	para "Yes, juitsu like"
	line "POISON FANG and"

	para "SLUDGE BOMB have"
	line "a similar effect,"

	para "but TOXIC always"
	line "BADLY POISONS!"
	done
...
FuchsiaGym_MapEvents:
	...
	def_object_events
	object_event  1, 10, SPRITE_JANINE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, FuchsiaGymJanineScript, EVENT_LEADERS_IN_SILVER
	object_event  5,  7, SPRITE_FUCHSIA_GYM_1, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, LassAliceScript, EVENT_BEAT_LASS_ALICE
	object_event  5, 11, SPRITE_FUCHSIA_GYM_2, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, LassLindaScript, EVENT_BEAT_LASS_LINDA
	object_event  9,  4, SPRITE_FUCHSIA_GYM_3, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, PicnickerCindyScript, EVENT_BEAT_PICNICKER_CINDY
	object_event  4,  2, SPRITE_FUCHSIA_GYM_4, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CamperBarryScript, EVENT_BEAT_CAMPER_BARRY
