...
SilverCaveRoom1_MapEvents:
	...
	object_event 11, 18, SPRITE_CHUCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 1, SilverCaveChuck, EVENT_FINAL_GAUNTLET
	...
	object_event 10,  2, SPRITE_PRYCE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 4, SilverCavePryce, EVENT_FINAL_GAUNTLET
