...
FisherJonahAfterBattleText:
	...
	para "I have many other"
	line "interests."

	para "Like sporting equi-"
	line "pment."

	para "..."
	line "..."

	para "Yes, basically just"
	line "fishing rods."
	done
...
BlackbeltWaiAfterBattleText:
	...
	line "under him, before"

	para "the KANTO Govern-"
	line "ment shut down"
	cont "his DOJO."

	para "I'd hope to find"
	line "him now that the"
	cont "war is over."

	para "He was rumored to"
	line "train in a cavern"

	para "beyond a raging"
	line "waterfall."
...
SailorKennethAfterBattleText:
	...
	para "Well after the war"
	line "many of the best"

	para "fighters were"
	line "imprisoned or killed."
	done
