...
OfficerKaneScript:
	trainer OFFICER, KANE, EVENT_BEAT_OFFICER_KANE, OfficerKaneSeenText, OfficerKaneWinText, 0, .Script

.Script:
	endifjustbattled
	opentext
	writetext OfficerKaneAfterText
	waitbutton
	closetext
	end

Route31Potion:
	itemball DUSK_BALL, 2

Route31PokeBall:
	itemball SAND_BALL, 2
...
OfficerKaneSeenText:
	...
	para "A family in"
	line "CHERRYGROVE has"

	para "just reported a"
	line "stolen EEVEE."

	para "The thief matches"
	line "your description."

	para "Let me check your"
	line "#MON!"

	para "That EEVEE doesn't"
	line "belong with you!"
...
OfficerKaneWinText:
	text "Clearly my mistake"
	line "the bond you have"

	para "with your EEVEE is"
	line "too strong for you"
	cont "to have stolen it."
	done

OfficerKaneAfterText:
	text "Go on then!"
	line "get out of here."

	para "Even if you did"
	line "steal the EEVEE,"

	para "you're more trouble"
	line "than you're worth."
	done
...
Route31YoungsterText:
	text "I found a SWINUB"
	line "And a LARVITAR in"
	cont "DARK CAVE."

	para "I'm going to raise"
	line "them to take on"
	cont "FALKNER."

	para "He's the leader of"
	line "VIOLET CITY's GYM."

	para "I bet they'll kick"
	line "his ass."
	done
...
Route31_MapEvents:
	...
	object_event 21, 13, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 5, TrainerBugCatcherWade1, -1
	object_event 33,  8, SPRITE_OFFICER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, OfficerKaneScript, EVENT_BEAT_OFFICER_KANE
