...
PicnickerBrookeAfterBattleText:
	...
	para "That's okay. I"
	line "like him for rea-"
	cont "sons other than"
...
OfficerDirkBeatenText:
	text "You're a talented"
	line "trainer, and don't"

	para "appear to be brea-"
	line "king any laws."
...
OfficerDirkAfterBattleText:
	text "We can never be"
	line "too careful."

	para "GOLDENROD is still"
	line "a hot-bed of"

	para "rebellion even now"
	line "three-years after"
	cont "KANTO won the war."
	done
...
Route35_MapEvents:
	...
	object_event 13, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_EMOTE, OBJECTTYPE_ITEMBALL, 0, Route35TMRollout, EVENT_ROUTE_35_TM_ROLLOUT
