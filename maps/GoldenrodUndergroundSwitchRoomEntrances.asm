...
UndergroundRivalBeforeText:
	...
	para "These fools are"
	line "going to send us"
	cont "back to war!"
	done
...
UndergroundRivalAfterText:
	...
	para "That's rich coming"
	line "from the butcher"
	cont "of GOLDENROD."
...
GruntM25SeenText:
	...
	para "The poor DIRECTOR"
	line "insisted on them"

	para "as a safety measure"
	line "when they built"

	para "the RADIO TOWER."
	line "Now, we're using"

	para "them to our adv-"
	line "antage!"
	done
...
GruntM25AfterBattleText:
	text "The DIRECTOR? He's"
	line "further inside,"
	
	para "But you'll never"
	line "make it that far!"

	para "We're going to rec-"
	line "the CLEAR BELL!"
...
BurglarEddieSeenText:
	...
	para "The KANTO big wigs"
	line "didn't care any-"
	cont "more. I guess they"

	para "got what they came"
	line "here for."

	para "Not much left for"
	line "me here. So, I'll"
	cont "take what's yours."
	done
...
GoldenrodUndergroundSwitchRoomEntrances_MapEvents:
	...
	warp_event 23, 10, GOLDENROD_UNDERGROUND_WAREHOUSE, 1
