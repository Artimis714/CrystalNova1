DEF CELADONGAMECORNERPRIZEROOM_TM24_COINS     EQU 8500
DEF CELADONGAMECORNERPRIZEROOM_TM09_COINS     EQU 8500
DEF CELADONGAMECORNERPRIZEROOM_TM30_COINS     EQU 8500
DEF CELADONGAMECORNERPRIZEROOM_TM14_COINS     EQU 8500
DEF CELADONGAMECORNERPRIZEROOM_TM23_COINS     EQU 8500
DEF CELADONGAMECORNERPRIZEROOM_TM01_COINS     EQU 8500
DEF CELADONGAMECORNERPRIZEROOM_TM40_COINS     EQU 8500
...
CeladonPrizeRoom_tmcounterloop:
	...
	verticalmenu
	closewindow
	ifequal 1, .DragonBreath
	ifequal 2, .RazorWind
	ifequal 3, .ShadowBall
	ifequal 4, .IceBeam
	ifequal 5, .FlashCannon
	ifequal 6, .DynamicPunch
	ifequal 7, .Crunch
	sjump CeladonPrizeRoom_CancelPurchaseScript

.DragonBreath:
	checkcoins CELADONGAMECORNERPRIZEROOM_TM24_COINS
	...
	takecoins CELADONGAMECORNERPRIZEROOM_TM24_COINS
	sjump CeladonPrizeRoom_purchased

.RazorWind:
	checkcoins CELADONGAMECORNERPRIZEROOM_TM09_COINS
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	getitemname STRING_BUFFER_3, TM_RAZOR_WIND
	scall CeladonPrizeRoom_askbuy
	iffalse CeladonPrizeRoom_CancelPurchaseScript
	giveitem TM_RAZOR_WIND
	iffalse CeladonPrizeRoom_notenoughroom
	takecoins CELADONGAMECORNERPRIZEROOM_TM09_COINS
	sjump CeladonPrizeRoom_purchased
...
.IceBeam:
	...
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	getitemname STRING_BUFFER_3, TM_ICE_BEAM
	scall CeladonPrizeRoom_askbuy
	iffalse CeladonPrizeRoom_CancelPurchaseScript
...
.FlashCannon:
	...
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	getitemname STRING_BUFFER_3, TM_FLASH_CANNON
	scall CeladonPrizeRoom_askbuy
	iffalse CeladonPrizeRoom_CancelPurchaseScript
...
.DynamicPunch:
	checkcoins CELADONGAMECORNERPRIZEROOM_TM01_COINS
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	getitemname STRING_BUFFER_3, TM_DYNAMICPUNCH
	scall CeladonPrizeRoom_askbuy
	iffalse CeladonPrizeRoom_CancelPurchaseScript
	giveitem TM_DYNAMICPUNCH
	iffalse CeladonPrizeRoom_notenoughroom
	takecoins CELADONGAMECORNERPRIZEROOM_TM01_COINS
	sjump CeladonPrizeRoom_purchased

.Crunch:
	checkcoins CELADONGAMECORNERPRIZEROOM_TM40_COINS
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	...
	giveitem TM_CRUNCH
	iffalse CeladonPrizeRoom_notenoughroom
	takecoins CELADONGAMECORNERPRIZEROOM_TM40_COINS
	sjump CeladonPrizeRoom_purchased
