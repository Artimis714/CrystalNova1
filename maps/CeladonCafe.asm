...
TeacherText_NoCoinCase:
	text "We're so glad RED"
	line "kicked those Hor-"
	cont "ible ROCKETS, out"
	cont "of CELADON!"
	done
...
CeladonCafe_MapEvents:
	...
	object_event  4,  3, SPRITE_WAITRESS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonCafeTeacher, -1
