...
LassMichelleSeenText:
	...
	para "Still gonna kick"
	line "your ass though."
	done
...
CeladonGym_MapEvents:
	...
	def_object_events
	object_event  5,  3, SPRITE_ERIKA, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonGymErikaScript, EVENT_LEADERS_IN_SILVER
