...
CooltrainermJakeAfterBattleText:
	...
	para "Were all fierce"
	line "warriors during"
	cont "the war."
	done
...
PsychicRichardSeenText:
	...
	line "you have so many."

	para "Kid, you wouldn't"
	line "last 5 minutes in"

	para "a battle against"
	line "a KANTO GYM"
	cont "LEADER!"
	done
...
PsychicRichardAfterBattleText:
	...
	para "the strength of"
	line "KANTO GYM leaders."

	para "..."
	line "..."

	para "No, full KANTO"
	line "CITIZENS don't need"

	para "eight badges to"
	line "face the ELITE"
	cont "FOUR."
