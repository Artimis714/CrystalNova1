...
ShinyVulpix:
	...
	startbattle
	disappear SPROUTTOWER3F_VULPIX
	reloadmapafterbattle
	end
...
SageLiFlashExplanationText:
	...
	para "Be well, young"
	line "trainer, and cont-"
	cont "inue on your path."

	para "After the years of"
	line "senseless violence"

	para "the world needs"
	line "more kind trainers"

	para "like you, to light"
	line "the darkness."
	done
...
SageNealAfterBattleText:
	...
	para "And let you bring"
	line "light where there"
	cont "is darkness."
	done
...
SproutTower3F_MapEvents:
	...
	object_event 13,  2, SPRITE_VULPIX, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_OW_BROWN, OBJECTTYPE_SCRIPT, 0, ShinyVulpix, EVENT_SHINY_VULPIX
