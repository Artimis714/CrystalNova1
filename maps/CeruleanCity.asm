	...
	const CERULEANCITY_OFFICER1
	const CERULEANCITY_OFFICER2
	const CERULEANCITY_OFFICER3
...
CeruleanCitySuperNerdScript:
	...
	iffalse .Alert
	checkevent EVENT_CERULEAN_ALERT
	iftrue .GetAwayfromMe
	writetext CeruleanCitySuperNerdText
	waitbutton
	closetext
	end
...
.Alert:
	...
	showemote EMOTE_SHOCK, CERULEANCITY_SUPER_NERD, 15
...
CeruleanTownCityPolice3Script:
	trainer OFFICER, GUARD, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_7, CeruleanPoliceSeenText, CeruleanPoliceWinText, 0, .Script

.Script:
	endifjustbattled
	opentext
	writetext CeruleanPoliceAfterBattleText
	waitbutton
	closetext
	end

CeruleanTownCityPolice2Script:
	trainer OFFICER, RAXIL, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_6, CeruleanPoliceSeenText, CeruleanPoliceWinText, 0, .Script
...
CeruleanTownCityPolice1Script:
	trainer OFFICER, CITYPOLICE, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_5, CeruleanPoliceSeenText, CeruleanPoliceWinText, 0, .Script
...
CeruleanPoliceWinText:
	text "On behalf of the"
	line "CERULEAN POLICE"
...
CeruleanCityYoungsterText1:
	...
	para "belonged to RED!"
	line "THE RED."

	para "The #MON escaped"
	line "and it pulled"

	para "the cave down on"
	line "RED!"

	para "Everyone thinks"
	line "RED died, but"
...
CeruleanCity_MapEvents:
	...
	object_event 23, 15, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeruleanCitySuperNerdScript, -1
	...
	object_event 30, 25, SPRITE_OFFICER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, CeruleanTownCityPolice1Script, EVENT_BEAT_CITY_POLICE_CERULEAN
	object_event 17, 23, SPRITE_OFFICER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, CeruleanTownCityPolice2Script, EVENT_BEAT_CITY_POLICE_CERULEAN
	object_event 21,  6, SPRITE_OFFICER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, CeruleanTownCityPolice3Script, EVENT_BEAT_CITY_POLICE_CERULEAN
