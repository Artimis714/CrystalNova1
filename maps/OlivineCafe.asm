...
OlivineCafeFishingGuruScript:
	faceplayer
	opentext
	pokemart MARTTYPE_FOODCOURT, MART_OLIVINE_FOOD
	closetext
	end
...
OlivineCafe_MapEvents:
	...
	object_event  7,  3, SPRITE_WAITRESS, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineCafeFishingGuruScript, -1
