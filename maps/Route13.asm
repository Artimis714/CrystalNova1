...
PokefanmAlexSeenText:
	text "We are of the"
	line "KANTO Aristocracy!"

	para "Bow down before my"
	line "regal #MON!"
	done
...
PokefanmAlexAfterBattleText:
	...
	para "No wonder you have"
	line "no appreciation"
	cont "for your betters!"
	done
...
BirdKeeperPerryAfterBattleText:
	...
	para "Explains why you"
	line "kicked our asses!"
	done
