...
ShinyPonyta:
	opentext
	writetext LakeOfRagePonytaText
	pause 15
	cry PONYTA
	closetext
	setevent EVENT_LAKE_OF_RAGE_BLUE_PONYTA
	loadwildmon PONYTA, 20
	loadvar VAR_BATTLETYPE, BATTLETYPE_FORCESHINY
	startbattle
	disappear LAKEOFRAGE_SHINY_PONYTA
	reloadmapafterbattle
	end
...
LakeOfRagePonytaText:
	text "An unusual blue"
	line "PONYTA is grazing."
...
LakeOfRage_MapEvents:
	...
	object_event 35,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_EMOTE, OBJECTTYPE_ITEMBALL, 0, LakeOfRageTMDetect, EVENT_LAKE_OF_RAGE_TM_DETECT
	object_event  4,  4, SPRITE_PONYTA, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ShinyPonyta, EVENT_LAKE_OF_RAGE_BLUE_PONYTA