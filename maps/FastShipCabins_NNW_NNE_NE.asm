...
PokemaniacEthanSeenText:
	...
	para "You should see"
	line "photoshoot in the"

	para "IV ISLAND SPRING"
	line "BREAK EDITION!"
	done
...
PokemaniacEthanAfterBattleText:
	text "LILY's hot, but"
	line "BUENA's the best!"

	para "Did you know she"
	line "used to be in the"
	cont "movies?"

	para "..."
	line "..."

	para "Not those kinds"
	line "of movies."
...
GentlemanEdwardSeenText:
	...
	para "Someone's stolen"
	line "my proof of KANTO"
	cont "CITIZENSHIP!"
	done
...
GentlemanEdwardAfterBattleText:
	text "They'll arrest me"
	line "for sure when we"
	cont "arrive in KANTO!"
	done
