...
.Bruno2:
	...
	waitbutton
	closetext
	winlosstext BrunoScript_BrunoBeatenText2, 0
...
BrunoScript_BrunoDefeatText2:
	...
	line "he let you believe"
	cont "he was dead."

	para "You'll have to ask"
	line "him someday."
	done
