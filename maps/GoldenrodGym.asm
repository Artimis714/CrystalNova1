...
BeautyVictoriaAfterBattleText:
	...
	para "have left, so"
	line "we still love her"

	para "even if she's a"
	line "GRASS DRAGON type."
	done
...
GoldenrodGym_MapEvents:
	...
	def_object_events
	object_event  9,  3, SPRITE_WHITNEY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, GoldenrodGymWhitneyScript, EVENT_LEADERS_IN_SILVER
