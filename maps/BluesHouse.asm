	...
	const BLUESHOUSE_SILVER_TROPHY
...
DaisyHelloText:
	...
	para "And I get it, he"
	line "was the #MON"

	para "LEAGUE CHAMP for"
	line "all of 5 minutes."

	para "But I wish he'd"
	line "be more reliable."
	done
...
SilverTrophyText:
	text "It's a well-loved"
	line "Silver Trophy"

	para "prominently dis-"
	line "played."
...
BluesHouse_MapEvents:
	...
	object_event  4,  3, SPRITE_SILVER_TROPHY, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SilverTrophyScript, -1