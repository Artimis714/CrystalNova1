...
FalknerFightDoneText:
	...
	para "You've got real"
	line "talent. I'll look"
	
	para "forward to hearing"
	line "about your prog-"
	cont "ress."
...
VioletGymGuideText:
	...
	para "Though all three"
	line "of FALKNER's"

	para "#MON have a sec-"
	line "ondary type that"
	
	para "is weak against"
	line "grass!"
	done
...
VioletGym_MapEvents:
	...
	def_object_events
	object_event  5,  1, SPRITE_FALKNER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, VioletGymFalknerScript, EVENT_LEADERS_IN_SILVER
