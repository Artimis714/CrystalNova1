...
SchoolboyBillyAfterBattleText:
	...
	para "Since KANTO's eco-"
	line "nomy is centered"

	para "exclusively around"
	line "#MON, and the"

	para "main research body"
	line "in all of KANTO,"

	para "exclusively stud-"
	line "ies #MON."
