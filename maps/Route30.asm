...
BugCatcherDonAfterText:
	...
	para "I wish you could"
	line "buy NET BALLS"
	cont "in this region."

	para "I've got a pen-"
	line "pal in HOEN that"
...
Route30_MapEvents:
	...
	object_event  1,  7, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherDon, -1
