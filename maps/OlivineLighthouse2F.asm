...
GentlemanAlfredAfterBattleText:
	...
	para "During the war we"
	line "relied on bitter"

	para "roots and herbs to"
	line "heal our #MON."

	para "This stuff always"
	line "had more of a kick"

	para "than the processed"
