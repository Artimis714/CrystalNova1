...
MortyIntroText:
	...
	para "This was true"
	line "long before the"

	para "great war tried"
	line "to steal our"
	cont "heritage."

	para "That obsessed man"
	line "told me how you"

	para "returned life to"
	line "the beasts long"

	para "buried in the"
	line "ruins of the"
	cont "BRASS TOWER."

	para "But our town has"
	line "more legends than"
...
MortyFightDoneText:
	...
	para "Perhaps a journey"
	line "not forged in the"

	para "fires of war is"
	line "the key to HO-OH."
	done
...
SageJeffreySeenText:
	...
	para "And when I pass"
	line "into the FOREST"
	cont "PROTECTOR's"

	para "embrace, I will"
	line "truly join them."
	done
...
SageJeffreyAfterBattleText:
	text "Every battle, I"
	line "feel I am closer"
	cont "to my own end."

	para "Many long years"
	line "we suffered in"

	para "the war. I think"
	line "I should like"
	cont "the rest."
	done
...
MediumMarthaAfterBattleText:
	text "You were brave in"
	line "the dark."

	para "Well done, young"
	line "one."
	done
...
EcruteakGym_MapEvents:
	...
	def_object_events
	object_event  5,  1, SPRITE_MORTY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, EcruteakGymMortyScript, EVENT_LEADERS_IN_SILVER
