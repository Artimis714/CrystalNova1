...
CameraGrunt2BeatenText:
	text "We'll keep coming"
	line "just try to stop"
	cont "us! AHAHA!"
	done

ScientistJedSeenText:
	text "Your probability"
	line "of escaping this"
...
ScientistJedBeatenText:
	text "It seems, I miss-"
	line "calculated."
	done

ScientistJedAfterBattleText:
	text "During the last"
	line "days of the war,"
	
	para "this was the base"
	line "for the resistance."

	para "They all perished"
	line "after RED's army"

	para "defeated them at"
	line "the battle of"
	cont "GOLDENROD."

	para "We honor their"
	line "memory, by working"
	cont "here."
	done
...
GruntM16SeenText:
	...
	para "We all know the"
	line "risks of what we're"
	cont "doing!"

	para "We'd rather die"
	line "than submit to"
	cont "KANTO!"
	done
