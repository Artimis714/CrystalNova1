...
Route7_MapEvents:
	...
	def_object_events
	object_event  14,  6, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route7OfficerScript, EVENT_CLEARED_SAFFRON_GUARDS
	object_event  14,  7, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route7OfficerScript, EVENT_CLEARED_SAFFRON_GUARDS