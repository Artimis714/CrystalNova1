...
.GiveLureBall:
	...
	writetext KurtsHouseKurtJustFinishedYourBallText
	promptbutton
	verbosegiveitemvar TEMPEST_BALL, VAR_KURT_APRICORNS
	iffalse .NoRoomForBall
...
.GiveMoonBall:
	...
	writetext KurtsHouseKurtJustFinishedYourBallText
	promptbutton
	verbosegiveitemvar SAND_BALL, VAR_KURT_APRICORNS
	iffalse .NoRoomForBall
...
.GiveLoveBall:
	...
	writetext KurtsHouseKurtJustFinishedYourBallText
	promptbutton
	verbosegiveitemvar FUME_BALL, VAR_KURT_APRICORNS
	iffalse .NoRoomForBall
...
KurtsHouseKurtMakingBallsMustWaitText:
	...
	para "when their leader"
	line "GIOVANNI surrend-"
	cont "ered."

	para "They want revenge"
	line "for losing the"
	cont "war."

	para "I can understand"
	line "that, but they'll"

	para "do anything and"
	line "hurt anyone to"
	cont "get that revenge!"
...
KurtsHouseKurtHonoredToMakeBallsText:
	...
	para "Normally I charge"
	line "but for you, I'll"

	para "happily make BALLS"
	line "for free."
...
KurtsHouseKurtWhatIsThatText:
	...
	line "carved from stone"

	para "but... there are"
	line "inner workings"

	para "similar to one of"
	line "my APRICORN BALLS"

	para "Hmm.... no..."
	line "I've never seen a"

	para "#COMPRESSION"
	line "MATRIX like this."

	para "This is ancient"
	line "Where in the"

	para "FOREST PROTECTOR'S"
	line "name did you find"
	cont "this?"
...
KurtsHouseKurtThisBallStartedToShakeText:
	...
	para "the GLYPH's in the"
	line "RUINS of ALPH!"

	para "To think, the"
	line "people all those"

	para "years ago, might've"
	line "been trainers too!"
	done
...
KurtsGranddaughterDadText:
	...
	para "When the KANTO"
	line "soldiers came to"

	para "AZALEA, my dad"
	line "agreed to go with"

	para "them so they'd"
	line "leave the rest of"
	cont "us alone."

	para "Grandpa says he's"
	line "teaching them to"

	para "make new kinds of"
	line "#BALLS."

	para "I miss my daddy."
	line "But spending time"

	para "with Grandpa is"
	line "fun too."
	done
