...
.NoRoom:
	...
	disappear FASTSHIPCABINS_SE_SSE_CAPTAINSCABIN_TWIN1
	pause 25
	special FadeInQuickly
	playmapmusic
	closetext
...
Welltakeourleavetext:
	text "Ship's docking soon"
...
SSAquaHasArrivedVermilionText:
	...
	para "You pat yourself"
	line "down to check you"

	para "have your KANTO"
	line "PAPERS ready for"

	para "inspection, but"
	line "they're missing."
	done
