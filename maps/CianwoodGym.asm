...
ChuckAfterText:
	...
	para "I still can't beat"
	line "my wife. She was"

	para "going to be the"
	line "GYM Leader here,"

	para "but FALKNER cried"
	line "when she showed"

	para "off her superior"
	line "Bird #MON."

	para "I married a hell"
	line "of a woman!"
	done
...
BlackbeltLaoAfterText:
	...
	para "and ghosts."
	line "Well maybe that"

	para "last one is just"
	line "me."
	done
...
CianwoodGym_MapEvents:
	...
	def_object_events
	object_event  4,  1, SPRITE_CHUCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CianwoodGymChuckScript, EVENT_LEADERS_IN_SILVER
