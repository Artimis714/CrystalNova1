...
PokefanmBrandonAfterText:
	...
	para "Worst of all it"
	line "lost some useful"
	cont "moves!"

	para "I hear there's a"
	line "MOVE REMINDER"
	cont "up in BLACKTHORN."

	para "I'll have to make"
	line "my way up there"
	cont "soon!"
	done
...
Route34TrainerTipsText:
	...
	para "SANDSTORM buffs"
	line "the Specl.Def for"
	cont "ROCK & GROUND"
	cont "type #MON."

	para "SMOG buffs the"
	line "Def & Spcl.Def"
	cont "for POISON type"
	cont "#MON."
	done
