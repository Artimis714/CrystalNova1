...
FisherMarvinAfterBattleText:
	...
	para "Too bad they were"
	line "discontinued."

	para "I wonder if any-"
	line "one still sells"
	cont "them."
	done
...
Route43TrainerTipsText:
	...
	para "Items which power"
	line "up a specific type"

	para "Such as the MAGNET"
	line "give a 30% power"

	para "boost to that type"
	line "rather than 10%."
