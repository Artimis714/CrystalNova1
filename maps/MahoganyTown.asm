...
MahoganyTownFisherText:
	...
	para "A woman who lives"
	line "somewhere off the"
	
	para "LAKE OF RAGE runs"
	line "a business making"

	para "rare BERRY JUICES"
	line "I've heard she's"

	para "trained her"
	line "SHUCKLE to make"

	para "juice from MOON"
	line "and SUN Berries!"
