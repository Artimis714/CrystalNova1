...
BurnedTowerB1FEusineText:
	...
	para "This was but a"
	line "taste of my dream!"

	para "Now to track the"
	line "ferrel beast!"
...
BurnedTowerB1F_MapEvents:
	...
	object_event 16,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_EMOTE, OBJECTTYPE_ITEMBALL, 0, BurnedTowerB1FTMEndure, EVENT_BURNED_TOWER_B1F_TM_ENDURE
