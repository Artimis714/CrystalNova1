	...
	const RUINSOFALPHOUTSIDE_FRUITTREE
...
AlphFruitTree:
	fruittree FRUITTREE_RUINS_ALPH
...
RuinsOfAlphOutside_MapEvents:
	...
	object_event  2, 20, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AlphFruitTree, -1
