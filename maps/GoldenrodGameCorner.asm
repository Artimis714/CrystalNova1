...
.GigaDrain:
	checkcoins GOLDENRODGAMECORNER_TM19_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	...
	iffalse GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	takecoins GOLDENRODGAMECORNER_TM19_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript
...
.Earthquake:
	checkcoins GOLDENRODGAMECORNER_TM26_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	getitemname STRING_BUFFER_3, TM_EARTHQUAKE
	scall GoldenrodGameCornerPrizeVendor_ConfirmPurchaseScript
	iffalse GoldenrodGameCornerPrizeVendor_CancelPurchaseScript
	giveitem TM_EARTHQUAKE
	iffalse GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	takecoins GOLDENRODGAMECORNER_TM26_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript

.SludgeBomb:
	checkcoins GOLDENRODGAMECORNER_TM36_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	getitemname STRING_BUFFER_3, TM_SLUDGE_BOMB
	scall GoldenrodGameCornerPrizeVendor_ConfirmPurchaseScript
	iffalse GoldenrodGameCornerPrizeVendor_CancelPurchaseScript
	giveitem TM_SLUDGE_BOMB
	iffalse GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	takecoins GOLDENRODGAMECORNER_TM36_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript

.PsychicM:
	checkcoins GOLDENRODGAMECORNER_TM29_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	...
	iffalse GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	takecoins GOLDENRODGAMECORNER_TM29_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript

.RockSlide:
	checkcoins GOLDENRODGAMECORNER_TM51_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	...
	iffalse GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	takecoins GOLDENRODGAMECORNER_TM51_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript
