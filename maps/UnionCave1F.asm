...
UnionCave1FGreatBall:
	itemball PARK_BALL, 3

UnionCave1FXAttack:
	itemball X_ATTACK

UnionCave1FPotion:
	itemball LURE_BALL, 2
...
FirebreatherBillAfterBattleText:
	...
	line "are DRAGON type"

	para "#MON that live in"
	line "this cave."
	done

FirebreatherRaySeenText:
	text "If you have light"
	line "a cave isn't"
	cont "scary."
...
FirebreatherRayAfterBattleText:
	text "We've been explor-"
	line "ing so many caves"

	para "since we visited"
	line "SPROUT TOWER!"
	done
