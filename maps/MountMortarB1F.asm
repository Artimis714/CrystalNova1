...
MountMortarB1FKiyoIntroText:
	...
	para "SAFFRON GYM back"
	line "in KANTO."

	para "But I disagreed"
	line "with the war."

	para "The INDIGO League"
	line "forcibly closed my"
	cont "GYM."

	para "I've lived here in"
	line "exile ever since!"

	para "And now I train"
	line "alone in the dark!"

	para "..."
	line "..."

	para "I see..."
	line "Very well. Test my"
	cont "resolve."
