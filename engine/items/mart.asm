...
BallShop:
	call FarReadMart
	call LoadStandardMenuHeader
	ld hl, Text_BallShop_Intro
	call MartTextbox
	call BuyMenu
	ld hl, Text_BallShop_ComeAgain
	jp MartTextbox

FoodCourt:
	call FarReadMart
	call LoadStandardMenuHeader
	ld hl, Text_FoodCourt_Intro
	call MartTextbox
	call BuyMenu
	ld hl, Text_FoodCourt_ComeAgain
	jp MartTextbox
...
.BallPointers:
	dw Text_BallShop_HowMany
	dw Text_BallShop_CostsThisMuch
	dw Text_BallShop_InsufficientFunds
	dw Text_BallShop_BagFull
	dw Text_BallShop_HereYouGo
	dw BuyMenuLoop


.FoodCourtPointers
	dw Text_FoodCourt_HowMany
	dw Text_FoodCourt_CostsThisMuch
	dw Text_FoodCourt_InsufficientFunds
	dw Text_FoodCourt_BagFull
	dw Text_FoodCourt_HereYouGo
	dw BuyMenuLoop
...
Text_BallShop_Intro:
	text_far BallShop_IntroText
	text_end

Text_BallShop_ComeAgain:
	text_far BallShop_ComeAgainText
	text_end

Text_BallShop_HowMany:
	text_far BallShop_HowManyText
	text_end

Text_BallShop_CostsThisMuch:
	text_far BallShop_CostsThisMuchText
	text_end

Text_BallShop_InsufficientFunds:
	text_far BallShop_InsufficientFundsText
	text_end

Text_BallShop_BagFull:
	text_far BallShop_BagFullText
	text_end

Text_BallShop_HereYouGo:
	text_far BallShop_HereYouGoText
	text_end

Text_FoodCourt_Intro:
	text_far FoodCourt_IntroText
	text_end

Text_FoodCourt_ComeAgain:
	text_far FoodCourt_ComeAgainText
	text_end

Text_FoodCourt_HowMany:
	text_far FoodCourt_HowManyText
	text_end

Text_FoodCourt_CostsThisMuch:
	text_far FoodCourt_CostsThisMuchText
	text_end

Text_FoodCourt_InsufficientFunds:
	text_far FoodCourt_InsufficientFundsText
	text_end

Text_FoodCourt_BagFull:
	text_far FoodCourt_BagFullText
	text_end

Text_FoodCourt_HereYouGo:
	text_far FoodCourt_HereYouGoText
	text_end