...
; entries correspond to item ids (see constants/item_constants.asm)
	...
	dw NoEffect            ; PASS
	dw RestoreHPEffect     ; SLVR_BERRY
	dw RestoreHPEffect     ; SLVR_B_JUICE
	...
	dw PokeBallEffect      ; TEMPEST_BALL
	dw PokeBallEffect      ; FUME_BALL
	dw PokeBallEffect      ; SAND_BALL
	dw RestorePPEffect     ; MYSTERYBERRY
	dw NoEffect            ; DRAGON_SCALE
	dw NoEffect            ; BERSERK_GENE
	dw NoEffect            ; KANTO_PAPERS
	dw NoEffect            ; ANCIENTRELIC
...
; which ball is used in a certain situation.
	...
	dbw TEMPEST_BALL, TempestBallMultiplier
	dbw FUME_BALL,    FumeBallMultiplier
	dbw SAND_BALL,    SandBallMultiplier
	db -1 ; end
