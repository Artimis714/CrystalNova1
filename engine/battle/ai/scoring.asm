...
; Encourage move if AI has good Sandstorm moves
	push hl
	ld hl, .GoodSandstormMoves
...
AI_Smart_Smog:
; Greatly discourage this move if the player is immune to Smog damage.
	ld a, [wBattleMonType1]
	push hl
	ld hl, .SmogImmuneTypes
	ld de, 1
	call IsInArray
	pop hl
	jr c, .greatly_discourage
...
; Encourage move if AI has good Smog moves
	push hl
	ld hl, .GoodSmogMoves
	call AIHasMoveInArray
	pop hl
