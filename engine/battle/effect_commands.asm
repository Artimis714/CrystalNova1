...
.FireBlastSmog:
; Return z if the current move always hits in smog, and it's smoggy.
	ld a, BATTLE_VARS_MOVE_EFFECT
	call GetBattleVar
	cp EFFECT_FIRE_BLAST
	ret nz
...
BattleCommand_PoisonTarget:
	...
	call CheckIfTargetIsGivenType
	ret z
	ld a, GHOST ; Don't poison a Ghost-type
	call CheckIfTargetIsGivenType
	ret z
	call GetOpponentItem
	ld a, b
...
BattleCommand_FlinchTarget:
	...
	ld a, FIGHTING ; Don't flinch a Fighting-type
	call CheckIfTargetIsGivenType
	ret z
...
BattleCommand_ConfuseTarget:
	ld a, PSYCHIC_TYPE ; Don't Confuse a Psychic-type
	call CheckIfTargetIsGivenType
	ret z
	call GetOpponentItem
	ld a, b
...
INCLUDE "engine/battle/move_effects/smog.asm"
