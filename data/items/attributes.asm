...
; X_ACCURACY
	item_attribute 500, HELD_ACCURACY_UP, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; LEAF_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; METAL_POWDER
...
; X_ATTACK
	item_attribute 500, HELD_ATTACK_UP, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; HELIX_FOSSIL
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_DEFEND
	item_attribute 500, HELD_DEFENSE_UP, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; X_SPEED
	item_attribute 500, HELD_SPEED_UP, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; X_SPECIAL
	item_attribute 500, HELD_SP_ATTACK_UP, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; COIN_CASE
...
; BLK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_SP_DEF
	item_attribute 500, HELD_SP_DEFENSE_UP, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; PNK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
...
; X_EVADE
	item_attribute 500, HELD_EVASION_UP, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_PARTY
; ENERGYPOWDER
...
; SLVR_B_JUICE
	item_attribute 700, HELD_BERRY, 70, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_B_JUICE
	item_attribute 1000, HELD_BERRY, 100, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; CHARCOAL
	item_attribute 1000, HELD_FIRE_BOOST, 35, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERRY_JUICE
	item_attribute 400, HELD_BERRY, 40, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; SCOPE_LENS
...
; GOLD_BERRY
	item_attribute 500, HELD_BERRY, 50, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; SQUIRTBOTTLE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; ITEM_B0
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
