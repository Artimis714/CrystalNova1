...
KantoPapersDesc:
	db   "Proof of full"
	next "KANTO CITIZENSHIP.@"

AncientRelicDesc:
	db   "An intact ceramic"
	next "vessel from ALPH.@"
...
BrickPieceDesc:
	db   "An ancient pottery"
	next "sherd from ALPH.@"
