...
MapGroup_Dungeons:
	...
	map SoulHouse, TILESET_HOUSE, DUNGEON, LANDMARK_LAV_RADIO_TOWER, MUSIC_BURNED_TOWER, FALSE, PALETTE_NITE, FISHGROUP_GHOST
...
MapGroup_Lavender:
	...
	map LavRadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_LAV_RADIO_TOWER, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_NITE, FISHGROUP_SHORE
