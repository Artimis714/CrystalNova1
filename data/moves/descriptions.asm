...
PsybeamDescription:
	db   "Psionic rays that"
	line "may confuse.@"

BubblebeamDescription:
	db   "A bubble jet that"
	line "may lower SPEED.@"
...
HailDescription:
	db   "Pelting hail falls"
	line "from above.@"

HexDescription:
	db   "Inflicts 2X to a"
	line "target w/status.@"
