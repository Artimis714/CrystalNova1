...
; entries correspond to ENGINE_* constants
	...
	engine_flag wDailyFlags2, DAILYFLAGS2_REVIVE_FOSSIL_F
	engine_flag wDailyFlags2, DAILYFLAGS2_ELMS_POKEDEX_CHECK_F

	engine_flag wSwarmFlags, SWARMFLAGS_BUENAS_PASSWORD_F
	engine_flag wSwarmFlags, SWARMFLAGS_GOLDENROD_DEPT_STORE_SALE_F

	engine_flag wPokecenterFlags, POKECENTERFLAGS_CHERRYGROVE_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_AZALEA_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_GOLDENROD_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_ECRUTEAK_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_OLIVINE_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_CIANWOOD_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_MAHOGANY_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_BLACKTHORN_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_ROUTE32_FEE
	engine_flag wPokecenterFlags, POKECENTERFLAGS_VIOLET_FEE
