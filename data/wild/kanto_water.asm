...
KantoWaterWildMons:
	...
	;  %, species,		min, max
	db 35, SEAKING, 	 25,  75
	db 25, AZUMARILL, 	 25,  75
	db 25, QUAGSIRE, 	 25,  75
	db 14, GYARADOS, 	 25,  75
	db  1, KANGASKHAN, 	 25,  75
	end_water_wildmons
	...
	db 6 percent ; encounter rate
	;  %, species,		min, max
	db 35, TENTACOOL, 	  1,  30
	db 25, HORSEA, 	          1,  22
	db 25, SEEL, 	          1,  30
	db 14, TENTACRUEL, 	 30,  45
	db  1, DEWGONG, 	 25,  45
	end_water_wildmons
	...
	;  %, species,		min, max
	db 35, TENTACOOL, 	   1, 30
	db 25, TENTACRUEL, 	  30, 45
	db 25, REMORAID, 	   1, 30
	db 14, MANTINE, 	   1, 45
	db  1, OCTILLERY, 	  25, 45
	end_water_wildmons
	...
	;  %, species,		min, max
	db 35, GOLDUCK, 	 40,  99
	db 25, QUAGSIRE, 	 40,  99
	db 25, GYARADOS, 	 40,  99
	db 14, JUMPLUFF, 	 40,  99
	db  1, FERALIGATR, 	 40,  99
	end_water_wildmons
