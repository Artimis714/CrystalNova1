	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, TOXIC, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, PROTECT, RAIN_DANCE, WEATHER_BALL, SOLARBEAM, IRON_TAIL, THUNDER, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SANDSTORM, DREAM_EATER, REST, ATTRACT, THIEF, NIGHTMARE, SUBSTITUTE, SWORDS_DANCE, BATON_PASS, STRENGTH, FLAMETHROWER, THUNDERBOLT, MEGAHORN, OUTRAGE
	; end
