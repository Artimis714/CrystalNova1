	...
	; tm/hm learnset
	tmhm CURSE, ROAR, TOXIC, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, GIGA_DRAIN, WILL_O_WISP, WEATHER_BALL, SOLARBEAM, DRAGONBREATH, THUNDER, EARTHQUAKE, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SANDSTORM, FIRE_BLAST, SWIFT, DREAM_EATER, REST, STEEL_WING, NIGHTMARE, SUBSTITUTE, FLY, STRENGTH, FLASH, FLAMETHROWER, THUNDERBOLT, RAZOR_WIND, SKY_ATTACK
	; end
