...
; BattleTowerMons group 1
	...
	db ESPEON
	db LEFTOVERS
	db MUD_SLAP, PSYCHIC_M, GROWTH, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db GOLD_BERRY
	db SHADOW_BALL, IRON_TAIL, SWORDS_DANCE, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db HERACROSS
	db GOLD_BERRY
	db REVERSAL, WILL_O_WISP, COUNTER, ROCK_SMASH
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db MR__MIME
	db QUICK_CLAW
	db TOXIC, GROWTH, FIRE_PUNCH, HEADBUTT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 2
	...
	db STARMIE
	db GOLD_BERRY
	db RECOVER, PSYCHIC_M, SURF, SCALD
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ALAKAZAM
	db BERRY_JUICE
	db PSYCHIC_M, GROWTH, TOXIC, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HERACROSS
	db FOCUS_BAND
	db WILL_O_WISP, REVERSAL, MEGAHORN, EARTHQUAKE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db WIGGLYTUFF
	db PINK_BOW
	db PSYCHIC_M, SWAGGER, SWORDS_DANCE, HEADBUTT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db ESPEON
	db MIRACLEBERRY
	db CONFUSION, SWIFT, TOXIC, GROWTH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 4
	...
	db SNORLAX
	db QUICK_CLAW
	db ATTRACT, BODY_SLAM, SWORDS_DANCE, EARTHQUAKE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PORYGON2
	db NO_ITEM
	db SHOCK_WAVE, ROCK_TOMB, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db EGG_BOMB, STOMP, GROWTH, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db SNORLAX
	db LEFTOVERS
	db HYPER_BEAM, EARTHQUAKE, SURF, SWORDS_DANCE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
...
; BattleTowerMons group 6
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, WEATHER_BALL
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db UMBREON
	db GOLD_BERRY
	db FAINT_ATTACK, MOONLIGHT, SWORDS_DANCE, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db HITMONLEE
	db FOCUS_BAND
	db REVERSAL, WILL_O_WISP, BODY_SLAM, MEGA_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HERACROSS
	db BRIGHTPOWDER
	db REVERSAL, WILL_O_WISP, MEGAHORN, EARTHQUAKE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
