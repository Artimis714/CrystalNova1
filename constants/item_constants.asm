...
; - ItemEffects (see engine/items/item_effects.asm)
	...
	const PASS         ; 86
	const SLVR_BERRY   ; 87
	const SLVR_B_JUICE ; 88
	const GOLD_B_JUICE ; 89
	const CHARCOAL     ; 8a
	const BERRY_JUICE  ; 8b
	const SCOPE_LENS   ; 8c
	const DUSK_BALL    ; 8d
	const LAVA_COOKIE  ; 8e
	const METAL_COAT   ; 8f
	const DRAGON_FANG  ; 90
	const EVIOLITE     ; 91
	const LEFTOVERS    ; 92
	const TEMPEST_BALL ; 93
	const FUME_BALL    ; 94
	const SAND_BALL    ; 95
	const MYSTERYBERRY ; 96
	const DRAGON_SCALE ; 97
	const BERSERK_GENE ; 98
	const KANTO_PAPERS ; 99
	const ANCIENTRELIC ; 9a
	const BIG_NUGGET   ; 9b
	const SACRED_ASH   ; 9c
	const HEAVY_BALL   ; 9d
