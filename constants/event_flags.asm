...
; Johto hidden items
	...
	const EVENT_GAVE_SCIENTIST_AMARANTH_RIB
...
; Kanto hidden items
	...
	const EVENT_ARCHIVESB1F_ITEM1
	const EVENT_ARCHIVESB1F_ITEM2
	const EVENT_ARCHIVESB1F_HIDDEN_ITEM1
	const EVENT_ARCHIVESB1F_HIDDEN_ITEM2
	const EVENT_ARCHIVESB1F_HIDDEN_ITEM3
	const EVENT_ARCHIVES1F_ITEM1
	const EVENT_ARCHIVES1F_ITEM2
	const EVENT_ARCHIVES1F_HIDDEN_ITEM1
	const EVENT_COLLAPSE_HOLE_1
	const EVENT_COLLAPSE_HOLE_2
	const EVENT_COLLAPSE_HOLE_3
	const EVENT_COLLAPSE_HOLE_4
...
; Kurt Apricorn events
	...
	const EVENT_GAVE_JUICER_BERRY
	const EVENT_GAVE_JUICER_SLVR_BERRY
	const EVENT_GAVE_JUICER_GOLD_BERRY
; Phone events
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_GOT_FRIEND_BALLS_FROM_QUIN
	const EVENT_GOT_GS_BALL_FROM_GOLDENROD_POKEMON_CENTER
	const EVENT_GOT_BONE_CLUB
	...
	const EVENT_GOT_SCOPE_LENS_CIANWOOD
	const EVENT_GOT_LIGHT_BALL_VIOLET_CITY
	const EVENT_READ_TOO_MUCH_ACADEMY
	const EVENT_BATTLED_EEVEE
	const EVENT_BATTLED_DITTO
	const EVENT_BATTLED_GOLBAT
	const EVENT_SPOKE_WITH_GRANNY_ILEX
	const EVENT_KID_VISITING_GRANNY_ILEX
	const EVENT_GRAMPS_LOVIN_UP_GRANNY_ILEX
	...
	const EVENT_GHOST_RACHAEL
	const EVENT_BABYBRORESTS
	const EVENT_ASK_YOUR_MOM_ABOUT_RED
	const EVENT_VERMILION_ALERT
	const EVENT_GOT_KANTO_PAPERS_BACK
	const EVENT_CERULEAN_ALERT
	const EVENT_SAFFRON_ALERT
	const EVENT_CELADON_ALERT
	const EVENT_FUCHSIA_ALERT
	const EVENT_CINNABAR_ALERT
	const EVENT_PEWTER_ALERT
	const EVENT_LAVENDER_ALERT
	const EVENT_VIRIDIAN_ALERT
	const EVENT_VERMILION_HEALER_ACTIVE
	const EVENT_LEARNED_ABOUT_WEATHER
	const EVENT_CLEARED_SAFFRON_GUARDS
	const EVENT_NUGGET_BRIDGE_AWAY
	const EVENT_READ_ELMS_RESEARCH_PAPER
	const EVENT_SPOKE_WITH_ARCHAEO_LASS1
	const EVENT_SPOKE_WITH_ARCHAEO_LASS2
	const EVENT_SPOKE_WITH_ARCHAEO_LASS3
	const EVENT_LEARNED_ABOUT_PROJECT_GENESIS
	const EVENT_MR_FUJI_ASSINATED
	const EVENT_MR_POKEMON_ASSINATED
	const EVENT_FAST_SHIP_OPAL2
	const EVENT_PRISON_ROCKETS
...
; Swimmer F
	...
	const EVENT_BEAT_SWIMMERF_GHOST_LOLITA
	const EVENT_BEAT_SWIMMERF_GHOST_KIKI
; Bird Keeper
...
; Burglar
	...
	const EVENT_BEAT_BURGLAR_GHOST_JAX
	const_skip ; unused
; Biker
...
; Firebreather
	...
	const EVENT_BEAT_FIREBREATHER_GHOST_AZAR
; Fisher
...
; Picnicker
	...
	const EVENT_BEAT_PICNIKER_JADE
; Guitarist
...
; Juggler
	...
	const EVENT_BEAT_JUGGLER_GHOST_ALDUS
; Gentleman
...
; Beauty
	...
	const EVENT_BEAT_BEAUTY_GHOST_SERENITY
	const EVENT_BEAT_BEAUTY_RACHAEL
	const EVENT_BEAT_BEAUTY_ELECTRA
	const EVENT_BEAT_BEAUTY_JOLENE
; Johto Gym Leaders
...
; Lass
	...
	const EVENT_BEAT_GHOST_LASS_RORY
	const EVENT_BEAT_LASS_AMBER
; Hiker
...
; Officer
	...
	const EVENT_BEAT_OFFICER_KANE
	const EVENT_BEAT_GATE_GUARD5
	const EVENT_BEAT_GATE_GUARD6
	const EVENT_BEAT_GATE_GUARD7
	const EVENT_BEAT_GATE_GUARD8
	const EVENT_BEAT_GATE_GUARD15
	const EVENT_BEAT_GATE_GUARD16
	const EVENT_BEAT_GATE_GUARD17
	const EVENT_BEAT_GATE_GUARD18
	const EVENT_BEAT_GATE_GUARD19
	const EVENT_BEAT_OFFICER_JERICHO
	const EVENT_BEAT_CITY_POLICE_VERMILION
	const EVENT_BEAT_CITY_POLICE_CELADON
	const EVENT_BEAT_CITY_POLICE_LAVENDER
	const EVENT_BEAT_CITY_POLICE_PEWTER
	const EVENT_BEAT_CITY_POLICE_VIRIDIAN
	const EVENT_BEAT_CITY_POLICE_FUCHSIA
	const EVENT_BEAT_CITY_POLICE_CINNABAR
	const EVENT_BEAT_CITY_POLICE_CERULEAN
	const EVENT_BEAT_OFFICER_GERALD
; CooltrainerM
...
; Medium
	...
	const EVENT_BEAT_MEDIUM_AGATHA
...
; Teacher
	...
	const EVENT_BEAT_TEACHER_QUINLEY
	const EVENT_BEAT_TEACHER_DOROTHY
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_SKIER_VRENI
	const EVENT_BEAT_SKIER_JANICA
	const EVENT_BEAT_SKIER_HANNI
	const EVENT_BEAT_BOARDER_ANTON
	const EVENT_BEAT_BOARDER_SCOTTY
	const EVENT_BEAT_BOARDER_TORSTEIN
	const EVENT_BEAT_ROCKER_AXEL
	const EVENT_BEAT_ROCKER_SEBASTIAN
	const EVENT_BEAT_ROCKER_NEIL
	const EVENT_BEAT_ROCKER_WOLFGANG
...
; New to Crystal
	...
	const EVENT_SILVER_CAVE_MEWTWO
	const EVENT_LAKE_OF_RAGE_BLUE_PONYTA
	const EVENT_LAVTOWER_GHOST_BEAUTY_SERENITY
	const EVENT_LAVTOWER_GHOST_SWIMMER_LOLITA
	const EVENT_LAVTOWER_GHOST_SWIMMER_KIKI
	const EVENT_LAVTOWER_GHOST_BURGLAR_JAX
	const EVENT_LAVTOWER_GHOST_FIREBREATHER_AZAR
	const EVENT_LAVTOWER_GHOST_JUGGLER_ALDUS
	const EVENT_LAVTOWER_GHOST_LASS_RORY
	const EVENT_MRPOKEMON_MASTER_BALL
	const EVENT_GOT_SMERGLE_FROM_DADDY
	const EVENT_HORTON_HAPPY_ENDING
	const EVENT_MAKING_FAKE_DOCS
	const EVENT_GOT_GRANDAD_SACRED_ASH
	const EVENT_KANTO_PAPERS_STOLEN
	const EVENT_GOT_BLACKBELT_FROM_DOJO
	const EVENT_MET_KIKIS_GRANDPARENTS
	const EVENT_HEARD_MR_FUJI_INTRO
	const EVENT_BURNEDTOWER_GHOST1
	const EVENT_BURNEDTOWER_GHOST2
	const EVENT_BURNEDTOWER_GHOST3
