...
DEF SPRITE_POKEMON EQU const_value
	...
	const SPRITE_SHUCKLE ; a4
	const SPRITE_ESPEON ; a5
	const SPRITE_UMBREON ; a6
	const SPRITE_VAPOREON ; a7
	const SPRITE_JOLTEON ; a8
	const SPRITE_FLAREON ; a9
	const SPRITE_PERSIAN ; aa
	const SPRITE_MEOWTH  ; ab
	const SPRITE_NIDORAN_F ; ac
	const SPRITE_PSYDUCK ; ad
	const SPRITE_NIDORINO ; ae
	const SPRITE_PIDGEY ; af
	const SPRITE_SPEAROW ; b0
	const SPRITE_RATTATA ; b1
	const SPRITE_BAYLEEF ; b2
	const SPRITE_KANGASKHAN ; b3
	const SPRITE_POLIWRATH ; b4
	const SPRITE_BLISSEY ; b5
	const SPRITE_ABRA ; b6
	const SPRITE_DRATINI ; b7
	const SPRITE_MILTANK ; b8
	const SPRITE_ELECTRODE ; b9
	const SPRITE_FARFETCH_D ; ba
	const SPRITE_FEAROW ; bb
	const SPRITE_DODRIO ; bc
	const SPRITE_MURKROW ; bd
	const SPRITE_EEVEE ; be
	const SPRITE_DITTO ; bf
	const SPRITE_GOLBAT ; c0
	const SPRITE_PONYTA ; c1
	const SPRITE_AMPHAROS ; c2
	const SPRITE_VULPIX ; c3
	const SPRITE_KRABBY ; c4
	const SPRITE_ONIX ; c5
