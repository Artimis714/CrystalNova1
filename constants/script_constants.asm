...
; UnownWalls and MenuHeaders_UnownWalls indexes (see data/events/unown_walls.asm)
	...
	const UNOWNWORDS_TIME   ; 3

; MoveTutor setval arguments
	const_def 1
	const MOVETUTOR_FIRE_BLAST   ; 1
	const MOVETUTOR_THUNDER      ; 2
	const MOVETUTOR_BLIZZARD     ; 3
...
; FossilScientist setval arguments
	...
	const REVIVE_AMARANTH_RIB ; 4

; BerryJuicer setval arguments
	const_def 1
	const JUICE_BERRY         ; 1
	const JUICE_SLVR_BERRY    ; 2
	const JUICE_GOLD_BERRY    ; 3