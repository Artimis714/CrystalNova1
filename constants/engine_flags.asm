...
; wUnlockedUnowns
	...
	const ENGINE_GOT_HEADBUTT
	const ENGINE_GOT_DIG
...
; wDailyFlags2
	...
	const ENGINE_REVIVE_FOSSIL
	const ENGINE_ELMS_POKEDEX_CHECK
; wSwarmFlags
	const ENGINE_BUENAS_PASSWORD_2
	const ENGINE_GOLDENROD_DEPT_STORE_SALE_IS_ON
; wPokecenterFlags
	const ENGINE_CHERRYGROVE_FEE
	const ENGINE_AZALEA_FEE
	const ENGINE_GOLDENROD_FEE
	const ENGINE_ECRUTEAK_FEE
	const ENGINE_OLIVINE_FEE
	const ENGINE_CIANWOOD_FEE
	const ENGINE_MAHOGANY_FEE
	const ENGINE_BLACKTHORN_FEE
	const ENGINE_ROUTE32_FEE
	const ENGINE_VIOLET_FEE
; wGameTimerPaused
	const ENGINE_62
; wPlayerGender
