...
; wDailyFlags2::
	...
	const DAILYFLAGS2_REVIVE_FOSSIL_F		      ; 8
	const DAILYFLAGS2_ELMS_POKEDEX_CHECK_F		      ; 9
...
; wPokecenterFlags::
	const POKECENTERFLAGS_CHERRYGROVE_FEE	; 0
	const POKECENTERFLAGS_AZALEA_FEE	; 1
	const POKECENTERFLAGS_GOLDENROD_FEE	; 2
	const POKECENTERFLAGS_ECRUTEAK_FEE	; 3
	const POKECENTERFLAGS_OLIVINE_FEE	; 4
	const POKECENTERFLAGS_CIANWOOD_FEE	; 5
	const POKECENTERFLAGS_MAHOGANY_FEE	; 6
	const POKECENTERFLAGS_BLACKTHORN_FEE	; 7
	const POKECENTERFLAGS_ROUTE32_FEE	; 8
	const POKECENTERFLAGS_VIOLET_FEE	; 9
